        ...
        <div class="other-pages">
            <div class="other-pages-back-div">
                <div class="text-content-div animated fadeIn">
                    ...
                    <div class="btn-div">
                        <a href="<?php echo $website_url?>/agent/" title="Start as a student">
                        <button class="sign-up" title="Agent Account">Agent Account <i class="bi-chevron-right"></i></button></a>
                        <a href="<?php echo $website_url?>/agent/sign-up"" title="Become An Agent">
                        <button class="sign-up right-btn" title="Become An Agent">Become An Agent <span>It's Free!</span></button></a>
                    </div>                   
                </div>
