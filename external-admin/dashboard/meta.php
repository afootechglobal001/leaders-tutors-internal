...
<link href="<?php echo $websiteUrl?>/dashboard/style/main-style.css?v=<?php echo $codeVersion?>" type="text/css"rel="stylesheet" />
<link href="<?php echo $websiteUrl?>/dashboard/style/nav-style.css?v=<?php echo $codeVersion?>" type="text/css"rel="stylesheet" />
<link href="<?php echo $websiteUrl?>/dashboard/style/jquery.datetimepicker.css" type="text/css"rel="stylesheet"/>
...
<script src="<?php echo $websiteUrl?>/dashboard/js/jquery.datetimepicker.js"></script>
<script src="<?php echo $websiteUrl?>/dashboard/js/chart.min.js"></script>
