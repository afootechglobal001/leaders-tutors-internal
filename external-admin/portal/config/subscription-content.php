<?php if ($page == 'subscriptionPage') { ?>
    <div class="page-title-div" data-aos="fade-in" data-aos-duration="1500">
        <div class="title-div">
            ...
            <div class="text-div">
                <h3>Subscriptions</h3>
                <p>Manage student subscription plans, track active and expired memberships, and ensure seamless access to tutorial services.</p>
            </div>
        </div>

        <div class="btn-div">
            <div class="search-div">
                <input type="text" id="searchContent" onkeyup="_filterEbooks(this.value);" placeholder="Search Subscription Here...">
