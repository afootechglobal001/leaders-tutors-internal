...
<link href="<?php echo $website_url ?>/style/paramount.css?v=<?php echo $code_version ?>" type="text/css"
    rel="stylesheet" />
<link href="<?php echo $website_url ?>/style/main-style.css?v=<?php echo $code_version ?>" type="text/css"
    rel="stylesheet" />
