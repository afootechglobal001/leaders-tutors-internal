    ...
    <div class="slide-form-div animated fadeInRight">
        ...
        <div class="container-back-div">
            <div class="inner-div">
                ...
                <div class="title">PHONE NUMBER: <span>*</span>
                    <div id="mobile_info" style="float:right;font-size:12px;display:none;color:#f00"><span>Mobile not accepted!</span></div>
                </div>
                ...
                <select id="reg_status_id" class="text_field selectinput" title="SELECT STATUS">
                    ...
                    <script>
                        _get_select_status('reg_status_id', '1,2');
                    </script>
                </select>
...
<?php if ($page == 'update_subject') { ?>
    ...
    <script>
        _fetch_each_subject('<?php echo $ids ?>');
    </script>
<?php } ?>
...
<?php if ($page == 'update_classes') { ?>
    ...
    <script>
        _fetch_each_class('<?php echo $ids ?>');
    </script>
<?php } ?>
...
<?php if ($page == 'update_dept') { ?>
    ...
    <script>
        _fetch_each_department('<?php echo $ids ?>');
    </script>
<?php } ?>
...
<?php if ($page == 'add_class_dept') { ?>
    ...
    <script>
        _get_fetch_all_classes('fetch_classes_checkbox');
    </script>
    <script>
        _get_fetch_form_class_dept('<?php echo $ids ?>');
    </script>
<?php } ?>
...
<?php if ($page == 'add_subject_class') { ?>
    ...
    <script>
        _get_fetch_all_subject('fetch_subject_checkbox');
    </script>
    <script>
        _get_fetch_form_subject_class('<?php echo $department_id ?>', '<?php echo $class_id ?>');
    </script>
<?php } ?>
    ...
    <div class="caption-div animated zoomIn">
        ...
        <div class="div-in animated fadeInRight">
            ...
            <select id="department_id" onchange="_get_class('department_id','class_id');" class="text_field selectinput" title="SELECT DEPARTMENT">
                ...
                <script>
                    _get_select_department('department_id');
                </script>
            </select>
...
<?php if ($page == 'video_reg') { ?>
                    ...
                    <script>
                        ...
                        function showVideo(input) {
                            ...
                            if (input.files && input.files[0]) {
                                ...
                                videoDisplay.load(); // important
                                videoDisplay.play().catch(() => {}); // optional autoplay
    ...
    <script>
        _get_fetch_department_class_subject_form('<?php echo $department_id ?>', '<?php echo $class_id ?>')
    </script>
    <script>
        _get_fetch_subject_form('<?php echo $subject_id ?>')
    </script>
<?php } ?>
...
<?php if ($page == 'update_video') { ?>
        ...
        <div class="container-back-div">
            <div class="inner-div">
                ...
                <select id="subject_id" class="text_field selectinput" title="SUBJECT">
                    ...
                    <script>
                        _fetch_select_subject('subject_id');
                    </script>
                </select>
    ...
    <script>
        _get_fetch_each_video_tutorial('<?php echo $tutorial_id ?>')
    </script>
    <script>
        _get_fetch_department_class_subject_form('<?php echo $department_id ?>', '<?php echo $class_id ?>')
    </script>
...
<?php if ($page == 'alert-read') { ?>
    ...
    <script>
        _fetch_read_alert('<?php echo $ids ?>');
    </script>
<?php } ?>
            ...
            <div class="table-div animated fadeIn" id="search-content">
                <div class="div-in">
                    ...
                    <table class="table" cellspacing="0" style="width:100%" id="fetch_all_transaction_history">
                        <script>
                            _get_user_transaction('<?php echo $page ?>', '<?php echo $ids ?>', '', '', '', '');
                        </script>
                        <tr class="tb-col">
                            <td>SN</td>
                            <td>DATE</td>
...
<?php if ($page == 'cbt_page_details') { ?>
            ...
            <div id="get_page_details">
                ...
                <div class="question-back-div">
                    ...
                    <div class="question-body-div" id="fetch_all_question_bank">
                        <script>
                            _get_fetch_question_bank('<?php echo $ids ?>')
                        </script>
    ...
    <script>
        _get_fetch_quiz_details('<?php echo $ids ?>')
    </script>
<?php } ?>
    ...
    <div id="get_page_details">
        <div class="question-back-div">
            ...
            <div class="question-body-div" id="fetch_all_quiz_question">
                <script>
                    _get_fetch_quiz_question('<?php echo $ids ?>')
                </script>
                <!-- <div class="question-div">
                    <div class="div-in">
                        <div class="check-div">
...
<?php if ($page == 'load_questions_manually') { ?>
    ...
    <?php if (!empty($question_id)) { ?>
        <script>
            _get_fetch_each_quiz_question('<?php echo $ids ?>', '<?php echo $question_id ?>')
        </script>
    <?php } ?>
<?php } ?>
            ...
            <div class="input-div">
                <div class="input-div-in">
                    ...
                    <select id="quiz_hour" class="text_field selectinputs" title="00:">
                        <option value="" selected="selected"> -- </option>
                        <script>
                            _fetchTimeCountOption('quiz_hour', 12);
                        </script>
                    </select>
                </div>
                <div class="input-div-in">
                    ...
                    <select id="quiz_min" class="text_field selectinputs" title="00:">
                        <option value="" selected="selected"> -- </option>
                        <script>
                            _fetchTimeCountOption('quiz_min', 60);
                        </script>
                    </select>
                </div>
                <div class="input-div-in">
                    ...
                    <select id="quiz_sec" class="text_field selectinputs" title="00;">
                        <option value="" selected="selected"> -- </option>
                        <script>
                            _fetchTimeCountOption('quiz_sec', 60);
                        </script>
                    </select>
                </div>
            </div>
            ...
            <div class="inner-div">
                ...
                <div class="alert alert-success">
                    ...
                    <select id="reg_company_status_id" class="text_field selectinput" title="SELECT COMPANY STATUS">
                        ...
                        <script>
                            _get_select_status('reg_company_status_id', '1,2');
                        </script>
                    </select>
                </div>
                ...
                <div class="alert alert-success">
                    ...
                    <select id="reg_contact_role_id" class="text_field selectinput" title="SELECT ROLE">
                        <option value="" selected="selected">SELECT ROLE</option>
                        <script>
                            _get_select_role('reg_contact_role_id');
                        </script>
                    </select>
                    ...
                    <select id="reg_contact_status_id" class="text_field selectinput" title="SELECT CONTACT PERSON STATUS">
                        ...
                        <script>
                            _get_select_status('reg_contact_status_id', '1,2');
                        </script>
                    </select>
                </div>
...
<?php if ($page == 'agent_profile') { ?>
                                ...
                                var chart = new CanvasJS.Chart("chartContainer", {
                                    ...
                                    data: [{
                                            ...
                                            dataPoints: [
                                                ...
                                                {
                                                    x: new Date(2024, 0, 29),
                                                    y: 960
                                                },
                                                {
                                                    x: new Date(2024, 0, 27),
                                                    y: 150
                                                },
                                                {
                                                    x: new Date(2024, 0, 25),
                                                    y: 700
                                                },
                                                {
                                                    x: new Date(2024, 0, 23),
                                                    y: 555
                                                },
                                                {
                                                    x: new Date(2024, 0, 19),
                                                    y: 362
                                                },
                                                {
                                                    x: new Date(2024, 0, 17),
                                                    y: 446
                                                },
                                                {
                                                    x: new Date(2024, 0, 16),
                                                    y: 825
                                                },
                                                {
                                                    x: new Date(2024, 0, 15),
                                                    y: 270
                                                },
    ...
    <script>
        _get_fetch_each_agent('<?php echo $ids ?>');
    </script>
<?php } ?>
    ...
    <div class="company-back-div-in">
        <div class="dashboard-content">
            ...
            <div class="list" id="fetch_all_contact_person">
                <script>
                    _get_fetch_all_contact_person('<?php echo $ids ?>');
                </script>
                <!-- <div class="student-profile">
                    <div class="details">
                        <div class="status-icon"><i class="bi-check"></i></div>
                        <div class="pix"><img src="<?php //echo $website_url
                                                    ?>/admin/a/all-images/images/avatar.jpg" alt="Profile Picture"/></div>
                        <div class="text">
                            <h3>Paul Emmanuel</h3>
                            <div class="info">
                                <div>
...
<?php if ($page == 'update_contact_person_form') { ?>
    ...
    <script>
        _get_fetch_each_contact_person('<?php echo $company_id ?>', '<?php echo $staff_id ?>');
    </script>
    <script>
        function updateCompanyTitle() {
            const companyName = document.getElementById('company_name');
        ...
        <div class="container-back-div">
            <div class="inner-div">
                ...
                <div class="setting_detail" id="channge_password">
                    ...
                    <div class="title" style="float:left;">COMFIRM NEW PASSWORD:<span>*</span>
                        <div id='message' style="float:right;margin-left:10px;"></div>
                    </div>
