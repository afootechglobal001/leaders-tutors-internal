...
$subject="$login_agent_fullname Invitation to Leaders Tutors app declined. ID: $login_agent_staff_id";
$message='
...
This is to inform your organization that your contact staff whose name is <strong>'.$login_agent_fullname.'</strong> has declined your invitation to Leaders Tutors App as a/an <strong>'.$role_name.'</strong>.
</p>
