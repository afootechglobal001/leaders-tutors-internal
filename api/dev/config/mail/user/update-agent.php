...
$subject="$company_name partnership with Leaders Tutors app Updated. ID: $company_id";
$leadersTutorsCommission=$leaders_tutors_commission + $leaders_network_commission;
$message='
...
Leaders tutors acknowledged your partnership as an agent. Our revenue sharing formular is as follows:<br/>
 - Leaders Tutors: <strong>'.$leadersTutorsCommission.'%</strong><br/>
 - '.$reciever_name.': <strong>'.$company_commission.'%</strong><br/>
