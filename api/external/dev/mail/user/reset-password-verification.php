...
<div style="width:100%; background:#f4f6f8; padding:30px 0; font-family:Arial, Helvetica, sans-serif;">
  <div style="max-width:600px; margin:auto; background:#ffffff; border-radius:8px; overflow:hidden; box-shadow:0 4px 10px rgba(0,0,0,0.08);">
    ...
    <div style="padding:30px; color:#333333;">
        ...
        <h2 style="color:#01328E; margin-top:0;">Email Verification Required</h2>

        <p>Dear <strong>' . $fullName . '</strong>,</p>

        <p>We received a request to verify your email address for your <strong>Leaders Tutors External Exam Portal</strong> account.</p>
        ...
        <p style="margin-top:30px;">
            ...
            <a href="mailto:' . $supportEmail . '" style="color:#01328E;">' . $supportEmail . '</a>
        </p>
